...
public class FriendsFragment extends BaseFragment {
    private FloatingActionButton friends_fab;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_friends, container, false);
//悬浮按钮的点击事件
        friends_fab = (FloatingActionButton) view.findViewById(R.id.friends_fragment_fab);
        friends_fab.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                //Toast.makeText(FriendsFragment.this,"你点击了添加按钮",Toast.LENGTH_SHORT).show();
                LogUtil.d("你点击了悬浮添加按钮");
            }
        });
        initView(view);
        return view;
